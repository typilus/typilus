...
from typed_ast.ast3 import Add, Sub, Mult, Div, FloorDiv, Mod, LShift, RShift, BitOr, BitAnd, BitXor, Pow, MatMult, \
    ExtSlice, Index, Compare, Await, Lambda, arg, Global, Nonlocal, arguments, Name, comprehension, alias, \
    withitem, JoinedStr, Assign, AnnAssign, AugAssign, FormattedValue, TypeIgnore, Attribute, Module, ImportFrom
...
class AstGraphGenerator(NodeVisitor):
    ...
    def __visit_variable_like(self, name: Union[str, AST], lineno: int, col_offset: int,
                              can_annotate_here: Optional[bool], type_annotation: TypeAnnotationNode = None):
